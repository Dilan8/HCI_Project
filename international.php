                                    ...
                                    <div class="navbar-collapse">
                                        <div class="nav-inner">
                                            ...
                                            <li><a style="font-family: 'Poppins', sans-serif;" href="home.php">Home</a></li>
                                                ...
                                                <li class="active"><a style="font-family: 'Poppins', sans-serif;" href="international.php">International Booklists </a></li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2>Stafford International School</h2><p>  <a href="bookpage.php"><b> More </b> </a> </p>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <div class="product-area most-popular section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2>Asian Intrnational School - Colombo 05</h2><p>  <a href="bookpage.php"><b> More </b> </a> </p>
                    </div>
                </div>
            </div>
            <div class="row">
 ...
 <div class="product-area most-popular section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2>Asian International School - Battaramulla</h2><p>  <a href="bookpage.php"><b> More </b> </a> </p>
                    </div>
                </div>
            </div>
            <div class="row">
 ...
 <div class="product-area most-popular section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2>Stafford Sri Lanka School Doha</h2><p>  <a href="bookpage.php"><b> More </b> </a> </p>
                    </div>
                </div>
            </div>
            <div class="row">
