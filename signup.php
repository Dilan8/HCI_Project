                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="myForm" action="signin.php">
                                ...
                                <div class="form-group" style="position: relative; left:10px;">
                                    <input style="text-align: center;" type="submit" value="Signin" class="btn float-right login_btn">
                                </div>
                        ...
                        <div class="card-footer">
                            <div class="d-flex justify-content-center links">
                                <li><a style="font-family: 'Poppins', sans-serif;font-size:20px; padding:20px;" href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a style="font-family: 'Poppins', sans-serif;font-size:20px;" href="#"><i class="fab fa-google"></i></a></li>
