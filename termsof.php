...
<body>
<div id="mainpage">
    <h1 style="text-align: center;">Terms Of Services</h1>
	<div class-="row1">
		<div class="colomn1">
			<div class="card1">
				<div  class="leftside1">
				  <h2 class="commonsubtitle">Introduction</h2>
				  ...
				  <h2 class="commonsubtitle">Information on the Website</h2>
				   ...
				   <h2 class="commonsubtitle">Trade Marks</h2>
				  ...
				  <h2 class="commonsubtitle">External Links</h2>
				  <p>External links may be provided for your convenience, but they are beyond the control of the Website Owner and no representation is made as to their content. Use or reliance on any external links and the content thereon provided is at your own risk. When visiting external links you must refer to that external websites terms and conditions of use. No hypertext links shall be created from any website controlled by you or otherwise to this website without the express prior written permission of the Website Owner. Please contact us if you would like to link to this website or would like to request a link to your website.</p>
					<h2 class="commonsubtitle">Public Forums and User Submissions</h2>
				   <p>
		...
		<div class="colomn1">
			<div class="card1">   
				...
				<p><strong>a..</strong>&nbsp;defame, abuse, harass, stalk, threaten or otherwise violate the rights of other users or any third parties;</p>
				   
				<p><strong>b.</strong>&nbsp;publish, post, distribute or disseminate any defamatory, obscene, indecent or unlawful material or information;</p>
				<p><strong>c</strong>.&nbsp;post or upload files that contain viruses, corrupted files or any other similar software or programmes that may damage the operation of the Website Owner's and/or a third party's computer system and/or network;</p>
				<p><strong>d.</strong>&nbsp;violate any copyright, trade mark, other applicable&nbsp;<strong>Sri Lanka</strong>&nbsp;or international laws or intellectual property rights of the Website Owner or any other third party;</p>
				<p><strong>e.</strong>&nbsp;submit contents containing marketing or promotional material which is intended to solicit business.</p>
							
				
				
				   <h2 class="commonsubtitle">Specific Use</h2>
				   ...
				   <h2 class="commonsubtitle">Warranties</h2>
				   ...
				   <h2 class="commonsubtitle">Disclaimer of Liability.</h2>
				   <p>The Website Owner shall not be responsible for and disclaims all liability for any loss, liability, damage (whether direct, indirect or consequential), personal injury or expense of any nature whatsoever which may be suffered by you or any third party (including your company), as a result of or which may be attributable, directly or indirectly, to your access and use of the website, any information contained on the website, your or your company's personal information or material and information transmitted over our system. In particular, neither the Website Owner nor any third party or data or content provider shall be liable in any way to you or to any other person, firm or corporation whatsoever for any loss, liability, damage (whether direct or consequential), personal injury or expense of any nature whatsoever arising from any delays, inaccuracies, errors in, or omission of any share price information or the transmission thereof, or for any actions taken in reliance thereon or occasioned thereby or by reason of non-performance or interruption, or termination thereof.</p>
					<h2 class="commonsubtitle">Use of the Website.</h2>
				  <p>The Website Owner does not make any warranty or representation that information on the website is appropriate for use in any jurisdiction (other than&nbsp;<strong>Great Britain</strong>&nbsp;). By accessing the website, you warrant and represent to the Website Owner that you are legally entitled to do so and to make use of information made available via the website.</p>
			

			
				  <h2 class="commonsubtitle">General</h2>
				  <h3 class="subsubtitle">a. Entire Agreement.</h3>
		...
		<div class="colomn1">
			<div class="card1">	
				...
				<div class="leftside3">  
				  <h3 class="subsubtitle">b. Alteration.</h3>
				  ...
				  <h3 class="subsubtitle">c. Conflict.</h3>
				  ...
				  <h3 class="subsubtitle">d. Waiver.</h3>
				  ...
				  <h3 class="subsubtitle">e. Cession.</h3>
				  ...
				  <h3 class="subsubtitle">f. Severability.</h3>
				  ...
				  <h3 class="subsubtitle">g. Applicable laws.</h3>
				  <p>Any relevant terms and conditions, policies and notices shall be governed by and construed in accordance with the laws of&nbsp;<strong>Sri Lanka</strong>&nbsp;without giving effect to any principles of conflict of law. You hereby consent to the exclusive jurisdiction of the High Court of&nbsp;<strong>Sri Lanka</strong>&nbsp;in respect of any disputes arising in connection with the website, or any relevant terms and conditions, policies and notices or any matter related to or in connection therewith.</p>
				  <h3 class="subsubtitle">h. Comments or Questions.</h3>
				  <p>If you have any questions, comments or concerns arising from the website, the&nbsp;<a href="http://www.sarasavi.lk/privacy-policy">privacy policy</a>&nbsp;or any other relevant terms and conditions, policies and notices or the way in which we are handling your personal information please&nbsp;<a href="http://www.sarasavi.lk/contacts/">contact us</a>.</p>        
				</div>
			</div>
		</div>
	</div>
